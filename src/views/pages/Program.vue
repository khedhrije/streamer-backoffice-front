          ...
          <div class="card">
            ...
            <div class="p-fluid formgrid grid">
              ...
              <div class="field col-12 md:col-6">
                ...
                <Dropdown v-model="program.country" :options="countries" placeholder="Select a Country"
                          class="w-full md:w-14rem" />
              </div>
              <div class="field col-12 md:col-6">
                <label for="state">Language</label>
                <Dropdown v-model="program.language" :options="languages" placeholder="Select a Language"
                          class="w-full md:w-14rem" />
              </div>
              <div class="field col-12 md:col-6">
              ...
              <div class="field col-12 md:col-6">
                ...
                <Dropdown id="status" v-model="program.provider" :options="providers" optionLabel="label"
                  ...
                  <template #value="slotProps">
                    ...
                    <div v-else-if="slotProps.value && !slotProps.value.value">
                      <span :class="'provider-badge status-' + slotProps.value.toLowerCase()">{{ slotProps.value
                        }}</span>
                    </div>
                    <span v-else>
                                            {{ slotProps.placeholder }}
            ...
            <h5>Picture</h5>
            <FileUpload name="demo[]" url="/api/upload" @upload="uploadImage" :multiple="false" accept="image/*"
                        :maxFileSize="1000000">
              <template #empty>
