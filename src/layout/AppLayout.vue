    ...
    return {
      ...
      menu: [
        ...
        },
        {
          ...
          items: [
            { label: "Programs", icon: "pi pi-fw pi-id-card", to: "/programs" },
            { label: "Medias", icon: "pi pi-fw pi-check-square", to: "/medias" },
            { label: "Audios", icon: "pi pi-fw pi-bookmark", to: "/audios" }
          ]
        },
        {
          ...
          items: [
            ...
            { label: "Tags", icon: "pi pi-fw pi-check-square", to: "/tags" }
          ]
        },
        {
          label: "Display",
          icon: "pi pi-fw pi-sitemap",
          items: [
            { label: "Homepages", icon: "pi pi-fw pi-check-square", to: "/homepages" },
